                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Blog All Tables</li>
                            </ol>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($blogs as $item)
                                        <tr >
                                            ...
                                            <td><img src="{{ asset($item->blog_image) }}" style="height: 70px; width:60px"></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('delete.blog', $item->id) }}" class="btn btn-danger sm delete-btn" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
