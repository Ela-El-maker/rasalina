            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Blog Section Page</h4><br><br>
                        ...
                        <form action="{{route('update.blog')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="blog_category_id" aria-label="Default select example">
                                        ...
                                        @foreach ($blogCategories as $category)
                                             ...
                                             <option value="{{$category->id}}" {{$category->id ==$editBlog->blog_category_id ? 'selected' : ''}} >{{$category->blog_category}}</option>
                                        @endforeach
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="blog_title" type="text" value="{{$editBlog->blog_title}}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="blog_tags" type="text" value="{{$editBlog->blog_tags}}"
                                        data-role="tagsinput">
                                        @error('blog_title')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="image-preview">
                                            <img id="preview-img"
                                                 src="{{ !empty($editBlog->blog_image) ? url( $editBlog->blog_image) :  url('uploads/no_image.jpg') }}"
                                                 alt="Slide Image"
                                    ...
                                    <div class="col-sm-10">
                                        <div id="image-preview-2">
                                            <img id="preview-img-2"
                                                 src="{{ !empty($editBlog->blog_image_1) ? url( $editBlog->blog_image_1) :  url('uploads/no_image.jpg') }}"
                                                 alt="Slide Image"
                                                 style="max-width: 200px; max-height: 200px; display: block; margin-bottom: 10px;">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="image-preview-3">
                                            <img id="preview-img-3"
                                                 src="{{ !empty($editBlog->blog_image_2) ? url( $editBlog->blog_image_2) :  url('uploads/no_image.jpg') }}"
                                                 alt="Slide Image"
                                                 style="max-width: 200px; max-height: 200px; display: block; margin-bottom: 10px;">
