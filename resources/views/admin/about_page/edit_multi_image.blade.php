    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <input type="hidden" name="id" value="{{$editMultiImage->id}}">
                                ...
                                <div class="row mb-3">
                                    <label for="image-upload" class="col-sm-2 col-form-label">Edit Multi Image</label>
                                    ...
                                    <div class="col-sm-10">
                                        <div id="image-preview">
                                            ...
                                            <label for="image-upload" id="image-label" class="btn btn-primary">Choose
                                                File</label>
                                            <input type="file" name="multi_image" id="image-upload" 
