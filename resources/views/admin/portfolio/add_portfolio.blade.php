                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Portfolio Section Page</h4><br><br>
                            ...
                            <form action="{{ route('store.portfolio') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="portfolio_name" type="text" value=""
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="portfolio_title" type="text" value=""
                                            id="example-text-input">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="image-preview">
                                            <img id="preview-img" src="{{url('uploads/no_image.jpg') }}" alt="Slide Image"
