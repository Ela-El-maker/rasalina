                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Portfolio All Tables</li>
                            </ol>
                        </div>
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($portfolio as $item)
                                        <tr >
                                            <td>{{ $i++ }}</td>
                                            <td><img src="{{ asset($item->portfolio_image) }}" style="height: 70px; width:60px"></td>
                                            <td style="white-space: normal; word-wrap: break-word; overflow: hidden; text-overflow: ellipsis;">{{ $item->portfolio_name}}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('delete.portfolio', $item->id) }}" class="btn btn-danger sm delete-btn" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
