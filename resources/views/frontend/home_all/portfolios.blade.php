            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">Project Portfolios </h2>
                    ...
                    <div class="row gx-0 align-items-center">
                        <div class="col-lg-6 col-md-10">
                            <div class="portfolio__inner__thumb">
                                <a href="{{route('home.portfolio.details', $item->id)}}">
                        ...
                        <div class="col-lg-6 col-md-10">
                            <div class="portfolio__inner__content">
                                <h2 class="title"><a href="{{route('home.portfolio.details', $item->id)}}">{{$item->portfolio_name}}</a></h2>
                                <p>{{$item->portfolio_title}}</p>
                                <p>{!! Str::limit($item->portfolio_description, 150)!!}</p>
                                <a href="{{route('home.portfolio.details', $item->id)}}" class="link">View Case Study</a>
                            </div>
                        </div>
                    </div>
                </div> 
