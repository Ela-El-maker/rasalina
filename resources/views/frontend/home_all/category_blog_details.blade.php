                    ...
                    <div class="breadcrumb__wrap__content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Welcome to  {{$categoryName->blog_category}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    @foreach ($blogPost as $blog)
                       <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="{{route('home.blog.details',$blog->id)}}"><img src="{{asset($blog->blog_image)}}" alt=""></a>
                            <a href="{{route('home.blog.details',$blog->id)}}" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                        </div>
                        <div class="standard__blog__content">
                            ...
                            <h2 class="title"><a href="{{route('home.blog.details',$blog->id)}}">{{$blog->title}}</a></h2>
